...
task examples, "test-examples to execute":
  for cmd in [
              "bin/lmp_atom_regions tensor 2 2 2 10 10 10 0.5 1000,1,true 0,0.5,1,0,0.5,1,0,0.5,1",
              ...
              "bin/lmp_atom_regions tiled 2 2 2 10 10 10 0.0 1000,1,true 2,0.5,1,0.25,1,0.75,0,0.45,0,0.33,0,0.7,0,0.2",
              ]:
    echo "cmd: '" & cmd & "'"
    exec cmd
